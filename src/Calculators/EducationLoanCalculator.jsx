...
export default function EducationLoanCalculator() {
  ...
  const [interestRate, setInterestRate] = useState(9); // 9% typical education loan
  const [loanTerm, setLoanTerm] = useState(7); // 7 years default
  ...
  const COLORS = ['#2563eb', '#60a5fa']; // Blue theme
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        <div className="md:flex">
          ...
          <div className="md:w-1/2 p-6">
            <h1 className="text-2xl font-bold text-gray-800 mb-2">Education Loan Calculator</h1>
