...
export default function PersonalLoanCalculator() {
  ...
  // Calculate EMI (Personal Loan Formula)
  const calculateEMI = () => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        <div className="md:flex">
          ...
          <div className="md:w-1/2 p-6 bg-amber-50">
            ...
            <div className="space-y-4">
              <div className="bg-white p-4 rounded-lg shadow-sm border border-amber-200">
                ...
                <p className="text-2xl font-bold text-orange-600">{formatINR(loanAmount)}</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-sm border border-amber-200">
                <p className="text-gray-600">Total Interest</p>
                <p className="text-2xl font-bold text-amber-500">{formatINR(totalInterest)}</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-sm border border-amber-200">
                <p className="text-gray-600">Total Payment</p>
                <p className="text-2xl font-bold text-orange-700">{formatINR(totalPayment)}</p>
              </div>
            </div>
          </div>
          ...
          <div className="md:w-1/2 p-6">
            <h1 className="text-2xl font-bold text-gray-800 mb-2">Personal Loan Calculator</h1>
            ...
            <div className="bg-orange-50 p-4 rounded-lg border border-orange-100">
              ...
              <p className="text-3xl font-bold text-orange-700">{formatINR(monthlyPayment)}</p>
