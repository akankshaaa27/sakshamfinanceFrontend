...
const LoanAgainstPropertyPage = () => {
  ...
  const calculateEMI = () => {
    const rate = 9.5 / 100 / 12; // Monthly interest rate
  ...
  const features = [
    {
      ...
      desc: "Get loans up to 70% of your property value with competitive interest rates"
    },
    {
      icon: <MdOutlinePayments className="text-3xl" />,
      title: "Long Tenure",
      desc: "Flexible repayment options up to 20 years to reduce EMI burden"
    },
    {
      icon: <FaUserShield className="text-3xl" />,
      title: "Continue Ownership",
      desc: "Keep using your property while availing loan benefits"
    },
    {
      icon: <FaBuilding className="text-3xl" />,
      title: "Multiple Property Types",
      desc: "Residential, commercial, industrial properties and land accepted"
    }
  ];
  ...
  const faqs = [
    {
      ...
      answer: "You can get up to 70% of your property's current market value, with maximum amounts varying by lender but typically up to ₹10 crores."
    },
    {
      question: "What documents are required?",
      answer: "You'll need property documents (title deed, tax receipts), identity/address proofs, income documents, and property valuation reports."
    },
    {
      question: "How long does the approval process take?",
      answer: "Typically 7-15 working days after document submission, depending on property verification and legal checks."
    },
    {
      question: "Can I prepay the loan?",
      answer: "Yes, most lenders allow prepayment after 6-12 EMIs with minimal charges (0-2% of outstanding amount)."
    },
    {
      question: "What properties are eligible?",
      answer: "Residential, commercial, industrial properties, and vacant land (with some restrictions) in approved locations."
    }
  ];
  ...
  const testimonials = [
    {
      name: "Rajesh Mehta",
      role: "Business Owner",
      content: "Used my commercial property to get funds for expansion at much lower rates than business loans.",
      rating: 5
    },
    {
      name: "Priya Sharma",
      role: "Doctor",
      content: "Got a large loan against my apartment for my daughter's overseas education. Process was smooth.",
      rating: 4
    },
    {
      name: "Vikram Singh",
      role: "Real Estate Developer",
      content: "LAP helped me bridge funding gaps between projects without selling my assets.",
      rating: 5
    }
  ];
        ...
        <div className="container mx-auto px-4 py-16 md:py-24 flex flex-col md:flex-row items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">
              Loan Against Property <span className="text-indigo-600">at 9.5%*</span>
            </h1>
            ...
            <div className="mt-10 flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Trusted by 10,000+ property owners</p>
              </div>
            </div>
          </motion.div>
            ...
            >
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Starting at 9.5% p.a.</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Calculate your EMI based on your property value</p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            <div className="lg:w-1/2 bg-indigo-50 p-8 rounded-2xl shadow-md">
              ...
              <div className="mb-8">
                ...
                <div className="flex justify-between text-xs text-gray-500 mt-1">
                  <span>₹5L</span>
                  <span>₹{(propertyValue * 0.7).toLocaleString('en-IN', {maximumFractionDigits: 0})}</span>
                </div>
                <p className="text-sm text-gray-600 mt-2">Max loan: 70% of property value</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-inner">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-medium">9.5% - 12% p.a.</p>
                  </div>
                  <div>
            ...
            <div className="lg:w-1/2">
              <h3 className="text-xl font-semibold text-gray-800 mb-6">Benefits of Loan Against Property</h3>
              ...
              <div className="mt-8 bg-indigo-600 text-white p-6 rounded-xl">
                ...
                <ul className="space-y-2">
                  <li className="flex items-center">
                    <FaCheck className="mr-2" /> Property ownership documents
                  </li>
                  <li className="flex items-center">
                    <FaCheck className="mr-2" /> Age 21-70 years
                  </li>
                  <li className="flex items-center">
                    <FaCheck className="mr-2" /> Minimum income ₹25,000/month
                  </li>
                  <li className="flex items-center">
                    <FaCheck className="mr-2" /> Property should be free from legal disputes
                  </li>
                </ul>
              </div>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Get your loan against property in 4 simple steps</p>
          </div>
            ...
            {[
              {
                ...
                desc: "Our experts evaluate your property's current market value",
                icon: "1"
              },
              {
                title: "Documentation",
                desc: "Submit property and income documents for verification",
                icon: "2"
              },
              {
                title: "Approval",
                desc: "Loan sanction based on property value and eligibility",
                icon: "3"
              },
              {
                title: "Disbursement",
                desc: "Receive funds in your account after legal process",
                icon: "4"
              }
            ].map((step, index) => (
              <motion.div 
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Trusted by property owners across India</p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Find answers to common questions about loans against property</p>
          </div>
